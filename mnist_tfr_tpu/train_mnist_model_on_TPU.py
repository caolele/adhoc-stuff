# python \
#     /usr/share/models/official/mnist/mnist_tpu.py \
#     --data_dir=gs://$GCS_BUCKET_NAME/mnist/data/ \
#     --model_dir=gs://$GCS_BUCKET_NAME/mnist/model \
#     --tpu=$TPU_NAME

# The example of Resnet is at https://github.com/tensorflow/tpu/blob/master/models/official/resnet/resnet_main.py
